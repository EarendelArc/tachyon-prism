...
- `client.json`：Tachyon Core 客户端配置，包含 `client.routing.game_profiles` 中的游戏配置文件、`client.routing.launchers` 中的启动器策略、`client.proxy.local_addrs` 中的 TGP 本地绑定地址，以及 `tgp.multipath` 中的多路径开关。
