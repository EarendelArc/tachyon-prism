...
const zh = {
  ...
  scanSteam: "扫描 Steam",
  selected: "已选择",
  xrayGenerationSelected: "已选择",
  xrayGenerationRunning: "当前运行",
  xrayGenerationPending: "待应用",
  xrayGenerationSwitching: "切换中",
  xrayGenerationRollingBack: "回滚中",
  xrayGenerationDegraded: "降级",
  xrayProxyConfirmed: "代理绑定已确认",
  settings: "设置",
...
const en: typeof zh = {
  ...
  selected: "Selected",
  xrayGenerationSelected: "Selected",
  xrayGenerationRunning: "Currently running",
  xrayGenerationPending: "Pending apply",
  xrayGenerationSwitching: "Switching",
  xrayGenerationRollingBack: "Rolling back",
  xrayGenerationDegraded: "Degraded",
  xrayProxyConfirmed: "Proxy binding confirmed",
  settings: "Settings",
